...
class Ship:
    ...
    def missile(self):
        ...
        a_missile = Sprite([missile_pos_x, missile_pos_y], [missile_vel_x,missile_vel_y], 0, 0, missile_image, missile_info, missile_sound)
...
def draw(canvas):
    ...
    canvas.draw_text("Lives: " + str(lives), (30, 50), 22, 'White')
    canvas.draw_text("Score: " + str(score), (WIDTH - 100, 50), 22, 'White')
...
#I added this keydown handler and keyup handler
...
a_rock = Sprite([WIDTH / 3, HEIGHT / 3], [1, 1], 0.5, 0.05, asteroid_image, asteroid_info)
